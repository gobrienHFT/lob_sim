...
The pack auditor in [scripts/audit_futures_pack.py](scripts/audit_futures_pack.py) checks that futures packs' summaries, trades CSVs, event traces, and manifests agree on fills, lifecycle counts, public queue-consumption totals, markouts, and artifact hashes.
