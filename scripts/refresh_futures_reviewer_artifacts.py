...
from scripts.refresh_futures_overlap_sensitivity import refresh_futures_overlap_sensitivity
...
def _refresh_steps() -> list[tuple[str, RefreshFunc]]:
    return [
        ...
        ("futures_overlap_sensitivity", refresh_futures_overlap_sensitivity),
