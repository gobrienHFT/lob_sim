...
- The audit claim is executable: the pack auditor checks summary JSON/CSV, trades, event trace, manifest, per-fill economics, and public-data assumption consistency across the committed futures packs.
