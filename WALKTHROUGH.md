...
- The audit claim is executable: the pack auditor checks summary JSON/CSV, trades, event trace, manifest, and public-data assumption consistency across the committed futures packs.
