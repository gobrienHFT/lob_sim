...
- A futures pack auditor that checks summary JSON/CSV, trades, event trace, manifest, and public-data assumption agreement on fills, lifecycle counts, public queue-consumption totals, markouts, and output artifact hashes.
